...
const PILIERS = [
  ...
  { num: '03', key: 'IA', title: 'Intégration de l’intelligence artificielle',
    short: 'Des modèles d’IA intégrés directement à vos applications pour analyser vos données, automatiser les tâches répétitives et anticiper grâce à la prédiction, à la vision par ordinateur et au traitement automatique des documents.',
    intro: 'Nous intégrons des modèles d’intelligence artificielle directement dans vos applications pour automatiser des traitements, analyser vos données et renforcer vos processus métier. L’IA s’exécute au cœur de vos outils : classification automatique, prédiction, lecture et extraction de documents (OCR), détection d’anomalies, pour accélérer les opérations et fiabiliser les décisions, sans jamais retirer le contrôle à l’utilisateur.',
    ...
    panelAccent2: '#7C6CFF',
    list: [
      'Extraction et lecture automatique de documents (OCR)',
      'Classification et catégorisation automatiques',
      'Prédiction et scoring (risque, priorité, montant)',
